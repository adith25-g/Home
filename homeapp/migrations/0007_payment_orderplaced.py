# Generated by Django 5.0.6 on 2024-12-25 08:23
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('homeapp', '0006_rename_product_cart_product_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('payment', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='homeapp.payment')),
            ],
        ),
    ]
